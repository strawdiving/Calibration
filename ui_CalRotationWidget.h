...
public:
    ...
    {
        CalRotationWidget->setWindowTitle(QApplication::translate("CalRotationWidget", "Form", 0));
        label_CalHelpText->setText(QApplication::translate("CalRotationWidget", "TextLabel", 0));
    } // retranslateUi
