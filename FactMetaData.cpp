...
void FactMetaData::setRawUnit(const QString &rawUnit)
{
    _rawUnit = rawUnit;
...
void FactMetaData::addEnumInfo(const QVariant &enumValue,const QString &enumString)
{
     _enumValues<<enumValue;
     _enumStrings<<enumString;
}
