						       ...
						       uint8_t v1, uint16_t v2, uint32_t v3, const uint32_t *ar_u32, const int32_t *ar_i32, const uint16_t *ar_u16, const int16_t *ar_i16, const uint8_t *ar_u8, const int8_t *ar_i8, const char *ar_c, const double *ar_d, const float *ar_f)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN, MAVLINK_MSG_ID_ARRAY_TEST_6_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN);
#endif
}
						           ...
						           uint8_t v1,uint16_t v2,uint32_t v3,const uint32_t *ar_u32,const int32_t *ar_i32,const uint16_t *ar_u16,const int16_t *ar_i16,const uint8_t *ar_u8,const int8_t *ar_i8,const char *ar_c,const double *ar_d,const float *ar_f)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ARRAY_TEST_6;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN, MAVLINK_MSG_ID_ARRAY_TEST_6_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN);
#endif
}
...
static inline void mavlink_msg_array_test_6_send(mavlink_channel_t chan, uint8_t v1, uint16_t v2, uint32_t v3, const uint32_t *ar_u32, const int32_t *ar_i32, const uint16_t *ar_u16, const int16_t *ar_i16, const uint8_t *ar_u8, const int8_t *ar_i8, const char *ar_c, const double *ar_d, const float *ar_f)
{
	...
	_mav_put_char_array(buf, 59, ar_c, 32);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_6, buf, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN, MAVLINK_MSG_ID_ARRAY_TEST_6_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_6, buf, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN);
#endif
#else
	mavlink_array_test_6_t packet;
	packet.v3 = v3;
	...
	mav_array_memcpy(packet.ar_c, ar_c, sizeof(char)*32);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_6, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN, MAVLINK_MSG_ID_ARRAY_TEST_6_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_6, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_6_LEN);
#endif
#endif
}
...
#else
	memcpy(array_test_6, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ARRAY_TEST_6_LEN);
#endif
}
