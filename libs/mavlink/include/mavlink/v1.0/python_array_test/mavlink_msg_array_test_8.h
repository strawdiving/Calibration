						       ...
						       uint32_t v3, const double *ar_d, const uint16_t *ar_u16)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN, MAVLINK_MSG_ID_ARRAY_TEST_8_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN);
#endif
}
						           ...
						           uint32_t v3,const double *ar_d,const uint16_t *ar_u16)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ARRAY_TEST_8;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN, MAVLINK_MSG_ID_ARRAY_TEST_8_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN);
#endif
}
...
static inline void mavlink_msg_array_test_8_send(mavlink_channel_t chan, uint32_t v3, const double *ar_d, const uint16_t *ar_u16)
{
	...
	_mav_put_uint16_t_array(buf, 20, ar_u16, 2);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_8, buf, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN, MAVLINK_MSG_ID_ARRAY_TEST_8_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_8, buf, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN);
#endif
#else
	mavlink_array_test_8_t packet;
	packet.v3 = v3;
	...
	mav_array_memcpy(packet.ar_u16, ar_u16, sizeof(uint16_t)*2);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_8, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN, MAVLINK_MSG_ID_ARRAY_TEST_8_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_8, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_8_LEN);
#endif
#endif
}
...
#else
	memcpy(array_test_8, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ARRAY_TEST_8_LEN);
#endif
}
