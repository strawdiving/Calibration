						       ...
						       uint8_t v, const uint32_t *ar_u32)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN, MAVLINK_MSG_ID_ARRAY_TEST_3_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN);
#endif
}
						           ...
						           uint8_t v,const uint32_t *ar_u32)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ARRAY_TEST_3;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN, MAVLINK_MSG_ID_ARRAY_TEST_3_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN);
#endif
}
...
static inline void mavlink_msg_array_test_3_send(mavlink_channel_t chan, uint8_t v, const uint32_t *ar_u32)
{
	...
	_mav_put_uint32_t_array(buf, 0, ar_u32, 4);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_3, buf, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN, MAVLINK_MSG_ID_ARRAY_TEST_3_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_3, buf, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN);
#endif
#else
	mavlink_array_test_3_t packet;
	packet.v = v;
	mav_array_memcpy(packet.ar_u32, ar_u32, sizeof(uint32_t)*4);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_3, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN, MAVLINK_MSG_ID_ARRAY_TEST_3_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ARRAY_TEST_3, (const char *)&packet, MAVLINK_MSG_ID_ARRAY_TEST_3_LEN);
#endif
#endif
}
...
#else
	memcpy(array_test_3, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ARRAY_TEST_3_LEN);
#endif
}
