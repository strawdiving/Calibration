...
static void mavlink_test_offboard_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_offboard_setpoint_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_pack(system_id, component_id, &msg , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_offboard_setpoint_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_send(MAVLINK_COMM_1 , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_offboard_setpoint_confirm(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_msg_offboard_setpoint_confirm_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_confirm_pack(system_id, component_id, &msg , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_confirm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_confirm_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_confirm_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_offboard_setpoint_confirm_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_offboard_setpoint_confirm_send(MAVLINK_COMM_1 , packet1.px_1 , packet1.py_1 , packet1.ph_1 , packet1.px_2 , packet1.py_2 , packet1.ph_2 , packet1.yaw , packet1.seq , packet1.total );
	mavlink_msg_offboard_setpoint_confirm_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_pump_comtroller(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_pump_comtroller_t packet_in = {
		5,72
    };
	mavlink_pump_comtroller_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_comtroller_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_pump_comtroller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_comtroller_pack(system_id, component_id, &msg , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_comtroller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_comtroller_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_comtroller_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_pump_comtroller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_pump_comtroller_send(MAVLINK_COMM_1 , packet1.pump_speed , packet1.spray_speed );
	mavlink_msg_pump_comtroller_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_extra_funtion(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_extra_funtion_t packet_in = {
		5,72,139,206,17
    };
	mavlink_extra_funtion_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_funtion_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_extra_funtion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_funtion_pack(system_id, component_id, &msg , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_funtion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_funtion_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_funtion_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_extra_funtion_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_extra_funtion_send(MAVLINK_COMM_1 , packet1.obs_avoid_enable , packet1.laser_height_enable , packet1.add_one , packet1.add_two , packet1.add_three );
	mavlink_msg_extra_funtion_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_pump_comtroller(system_id, component_id, last_msg);
	mavlink_test_pump_status(system_id, component_id, last_msg);
	mavlink_test_extra_funtion(system_id, component_id, last_msg);
